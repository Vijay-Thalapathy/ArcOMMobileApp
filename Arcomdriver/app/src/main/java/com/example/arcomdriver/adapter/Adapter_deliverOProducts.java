...
public class Adapter_deliverOProducts extends RecyclerView.Adapter<Adapter_deliverOProducts.QrViewHolder> {
    private ArrayList<Model_DeliverOProducts> itemList;

    private Context context;
    private Activity activity;
    public Adapter_deliverOProducts(Activity activity, ArrayList<Model_DeliverOProducts> list) {
        this.itemList = list;
