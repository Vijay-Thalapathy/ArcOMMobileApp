...
public class Activity_CreateOrder extends Activity_Menu {
    ...
    String settingsvalue ="0",default_netterms ="0",alert ="true";
...
@SuppressLint("Range")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Activity_CreateOrder.this, R.style.LoadingStyle);
        builder.setCancelable(false);
        LayoutInflater layoutInflater1 = Activity_CreateOrder.this.getLayoutInflater();
    ...
    try {
        ...
        RecyclerView.LayoutManager layoutManager = new WrapContentLinearLayoutManager(Activity_CreateOrder.this, LinearLayoutManager.VERTICAL, false);
            ...
            public void onClick(View view, int position) {
                ...
                view.findViewById(R.id.cart_product_delete_btn).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Calculation();
                        Toast.makeText(Activity_CreateOrder.this, "Item has been deleted successfully!", Toast.LENGTH_SHORT).show();
        ...
        findViewById(R.id.et_orderDate).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utils.getInstance().hideKeyboard(Activity_CreateOrder.this);
        ...
        findViewById(R.id.cus_img).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(Activity_CreateOrder.this, Activity_CreateCustomer.class);
                in.putExtras(bundle);
                startActivity(in);
       ...
       /* toolbar.setNavigationOnClickListener(new View.OnClickListener() {
        ...
        findViewById(R.id.bar_rll).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                IntentIntegrator integrator = new IntentIntegrator(Activity_CreateOrder.this);
        ...
        findViewById(R.id.ll_order).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Activity_CreateOrder.this, Activity_OrdersHistory.class));
            }
        });
        findViewById(R.id.ll_home).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Activity_CreateOrder.this, Activity_CustomerHistory.class));
            }
        });
        findViewById(R.id.ll_route).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Activity_CreateOrder.this, Activity_InvoiceHistory.class));
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (et_orderDate.getText().toString().equals("MM/DD/YYYY")) {
                   ...
                   /* if(settingsvalue.contains("Order")) {
                    ...
                    Utils.getInstance().hideKeyboard(Activity_CreateOrder.this);
                    if(wrBln){
                        if (Connectivity.isConnected(Activity_CreateOrder.this) &&
                                Connectivity.isConnectedFast(Activity_CreateOrder.this)) {
                            ...
                            SQLiteController sqLiteController = new SQLiteController(Activity_CreateOrder.this);
                            ...
                            try {
                                ...
                                showSuccess("Presale Created Successful");

                                /*Intent intent = new Intent(Activity_CreateOrder.this, Activity_OrdersHistory.class);
                                startActivity(intent);
                                Toast.makeText(Activity_CreateOrder.this, "Presale Order Created Successfully", Toast.LENGTH_SHORT).show();*/
                                ...
                                if(!str_customer.equals("Choose Customer")){
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            //OrdersSpinner
                                            SQLiteController sqLiteControllerC = new SQLiteController(Activity_CreateOrder.this);
                                    ...
                                    taxpercentage = "0.00";
                                    SQLiteController sqLiteController_tx = new SQLiteController(Activity_CreateOrder.this);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
               // AlertDialog.Builder builder = new AlertDialog.Builder(Activity_CreateOrder.this,android.R.style.Theme_Black_NoTitleBar_Fullscreen);
                ...
                LayoutInflater inflater = Activity_CreateOrder.this.getLayoutInflater();
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
               ...
               // dialog.getWindow().setLayout(WindowManager.LayoutParams.MATCH_PARENT,WindowManager.LayoutParams.MATCH_PARENT);
                ...
                RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(Activity_CreateOrder.this);
                mRecyclerProducts.setLayoutManager(mLayoutManager);
                mRecyclerProducts.setItemAnimator(new DefaultItemAnimator());
                mRecyclerProducts.addItemDecoration(new ItemDividerDecoration(Activity_CreateOrder.this, LinearLayoutManager.VERTICAL));
                // set the adapter object to the Recyclerview
                mRecyclerProducts.setAdapter(mAdapter);
                mRecyclerProducts.addOnItemTouchListener(new RecyclerViewTouchListener(Activity_CreateOrder.this, mRecyclerProducts, new RecyclerViewClickListener() {
                    @Override
                    public void onClick(View view, int position) {
                        ...
                        if (product_c != null && product_c.moveToFirst()) {
                            ...
                            do {
                               ...
                               // productImage =product_c.getString(product_c.getColumnIndex("all_product_img"));
                                ...
                                SQLiteController sqLiteController1 = new SQLiteController(Activity_CreateOrder.this);
                                sqLiteController1.open();
                                try {
  ...
  /*  private void showAlertQuantity(int i) {
                            ...
                            public void run() {
                                try {
                                    ...
                                    if(jr.length()>0){
                                        ...
                                        String sj = jr.getString(0);

                                        String[] Array = sj.split(" ");

                                        orderNumber = Array [2].substring(1);

                                        System.out.println("orderNumber----"+orderNumber);

                                        orderNumberStr = jr.getString(0);
                                    ...
                                    if ( succeeded == true) {
                                        ...
                                        Utils.getInstance().GetMasterInsert(Activity_CreateOrder.this,"CreateOrder",Progress_dialog,"");
                                        ...
                                        try {
                                            ...
                                            postCreateFull(json.toString(),data,orderNumber,orderNumberStr);
                                        } catch (JSONException e) {
                                            e.printStackTrace();
                                        }
                                    }
    ...
    private void postCreateFull(String json,String data,String orderNumber,String orderNumberStr) {
        try {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    if ( succeeded == true) {
                                        ...
                                        InsertOffline(data,orderNumber,orderNumberStr);
                                    }
    ...
    private void InsertOffline(String orderID,String orderNumber,String orderNumberStr) {
        ...
        try {
            ...
            sqLiteController.insertOrders(
                    ...
                    "",
                    "",
                    str_warehouseID,Str_CS,"Online","non_Sync","null",  "",str_fulfilmentID,str_TaxID,Str_TermsID,DueDate);

            for (int i = 0; i < list.size(); i++ ){

                double TotalBaseAmt = Double.parseDouble(list.get(i).getPrice_PerUnit().trim()) * Double.parseDouble(list.get(i).getProduct_quantity());

                sqLiteController.insertProducts(list.get(i).getProduct_id().trim(), orderID,list.get(i).getProduct_id().trim(),list.get(i).getPrice_PerUnit().trim(),String.valueOf(TotalBaseAmt),list.get(i).getProduct_quantity().trim(),list.get(i).getProduct_name().trim(),list.get(i).getIstaxable(),str_warehouseID);

            }

        } finally {

            showSuccess(orderNumberStr);
           /* Intent intent = new Intent(Activity_CreateOrder.this, Activity_OrdersHistory.class);
            startActivity(intent);
            Toast.makeText(Activity_CreateOrder.this, "Presale Order Created Successfully", Toast.LENGTH_SHORT).show();*/
            sqLiteController.close();
    ...
    private void showSuccess(String orderNumberStr) {
       ...
       // tittleAlert_tv.setText("Presale Created Successful");
        tittleAlert_tv.setText(orderNumberStr);
    ...
    private String getOrderCount() {
        tkSharedPreferences = getSharedPreferences(Activity_CreateOrder.tkPref,MODE_PRIVATE);
        if (tkSharedPreferences.contains(Activity_CreateOrder.order_Count)) {
            return tkSharedPreferences.getString(Activity_CreateOrder.order_Count, null);
        }
        return "0";
    }
    ...
    private String getOrderDate() {
        tkSharedPreferences = getSharedPreferences(Activity_CreateOrder.tkPref,MODE_PRIVATE);
        if (tkSharedPreferences.contains(Activity_CreateOrder.order_CrDate)) {
            return tkSharedPreferences.getString(Activity_CreateOrder.order_CrDate, null);
        }
        return "0";
    }
