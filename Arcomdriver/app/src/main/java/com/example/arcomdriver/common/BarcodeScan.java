...
public class BarcodeScan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surfaceView = findViewById(R.id.B_surface_view);
        barcodeText = findViewById(R.id.B_barcode_text);
    ...
    private void initialiseDetectorsAndSources() {
        ...
        cameraSource = new CameraSource.Builder(BarcodeScan.this, barcodeDetector)
